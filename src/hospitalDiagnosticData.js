...
[
    ...
    },
    {
        ...
        procedure: 'You will be awake during the procedure, but also will be administered medication to feel relaxed. An incision will be made, either at the top, inner part of your leg, or at your wrist, after being numbed. A tube will enter your heart through the incision site and the blood vessels. An X-ray will inform the doctor of when the tube reaches its destination where tests will be performed. For coronary angiography, a red dye will be injected, showing any blockages in the arteries. After the procedure, you will need to rest in the hospital for a few hours, and reschedule a follow up appointment regarding the results.',
    ...
    },
    {
        ...
        about: 'Transcatheter aortic valve replacement (TAVR) involves the insertion of a new aortic valve without removing the damaged valve. What is done is the collapsable new valve is placed inside the old valve via a catheter. As it expands, it pushes the old valve out of the way, and assumes blood flow regulation. Damaged valves arise due to aortic stenosis, when the aortic valve does not open fully, limiting blood flow.',
        procedure: '',
        warning: '',
    },
    {
