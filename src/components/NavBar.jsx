    ...
    render() {
        return (
            <div className="navbar">
                ...
                <div className="bar">
                    <Link to="/">Home</Link>
                    <div className="condition-menu" onMouseEnter={ this.toggleConditions } onMouseLeave={ this.toggleConditions }>
                        <Link>
                        ...
                        { this.state.showConditions
                        ?
                            <div className="dropdown-conditions">
                        ...
                        : <div className="collapse-conditions"/>
                        }
                    </div>
